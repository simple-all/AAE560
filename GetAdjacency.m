...
RadiusEarth=6371e3; %mean radius of Earth in m
Distance = cterm*RadiusEarth*0.000621371;%Distance between nodes in miles
Adjacency=accumarray(NodeIdConnect,1);
WeightedAdjacency=accumarray(NodeIdConnect,Distance);