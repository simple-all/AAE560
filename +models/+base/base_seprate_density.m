...
net2 = agents.vehicles.VehicleGenerator(0, 20 * 60, numEach, func2, 2, trafficGrid); % Density 1
simInst.addCallee(net2);

numLeft = numCars - (2 * numEach);
net3 = agents.vehicles.VehicleGenerator(0, 20 * 60, numLeft, func2, 3, trafficGrid); % Density 2
simInst.addCallee(net3);
