...
myTrafficGrid.addRoad(myTrafficGrid.intersections{2}, myTrafficGrid.intersections{3}, speedLimit);
myTrafficGrid.addRoad(myTrafficGrid.intersections{2}, myTrafficGrid.intersections{4}, speedLimit);
myTrafficGrid.addRoad(myTrafficGrid.intersections{2}, myTrafficGrid.intersections{5}, speedLimit);
myTrafficGrid.addRoad(myTrafficGrid.intersections{1}, myTrafficGrid.intersections{4}, speedLimit);
myTrafficGrid.addRoad(myTrafficGrid.intersections{4}, myTrafficGrid.intersections{5}, speedLimit);
